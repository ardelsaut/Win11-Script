...
# On telecharge le .exe de Git
    ...
    (New-Object Net.WebClient).DownloadFile("https://github.com/git-for-windows/git/releases/download/v2.34.1.windows.1/Git-2.34.1-64-bit.exe", "$pwd\Git-2.34.1-64-bit.exe")
...
# On installe git de manière unattended
    ...
    Start-Process "$pwd\Git-2.34.1-64-bit.exe" '/VERYSILENT /NOCANCEL /SP- /CLOSEAPPLICATIONS /RESTARTAPPLICATIONS /COMPONENTS="icons,ext\reg\shellhere,assoc,assoc_sh"'
